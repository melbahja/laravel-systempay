...

{
    ...
    /**
     * Set total amount order. If you doesn't give the amount in parameter, it will be automaticly calculated
    ...
    {
        $html_form = Form::open(array('url' => $this->_url, 'method' => 'post'));
        foreach ($this->_params as $key => $value)
            $html_form .= Form::hidden($key, $value);
        $html_form .= $button;
        $html_form .= Form::close();
        return $html_form;
    }
